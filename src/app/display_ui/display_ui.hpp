...
namespace display_ui {
	...
	display_ui::ErrorCode fixed_ui_print(grid_printer::GridPrinter& mc_obj);
	display_ui::ErrorCode temp_value_print(grid_printer::GridPrinter& mc_obj, std::int16_t temp_c_x10);
	display_ui::ErrorCode speed_value_print(grid_printer::GridPrinter& mc_obj, std::uint16_t speed_rpm);
}
...
/**
*
*	@fn 		display_ui::ErrorCode fixed_ui_print(grid_printer::GridPrinter& mc_obj)
*
*	@brief		Prints the fixed part of the UI on the display
*
*	@param[in]	mc_obj							Instance of the GridPrinter class
*
*	@retval		DisplayOperation				If an error occurs whith the GridPrinter class
*	@retval		Ok								If no error occurs
*
*	@pre		mc_obj must be a valid instance of the GridPrinter class correctly initialized
...
/**
*
*	@fn 		display_ui::ErrorCode temp_value_print(grid_printer::GridPrinter& mc_obj, std::int16_t temp_c_x10)
*
...
/**
*
*	@fn 		display_ui::ErrorCode speed_value_print(grid_printer::GridPrinter& mc_obj, std::uint16_t speed_rpm)
*
*	@brief		Prints the value of the tempearature reading on the display
*
*	@param[in]	mc_obj							Instance of the GridPrinter class
