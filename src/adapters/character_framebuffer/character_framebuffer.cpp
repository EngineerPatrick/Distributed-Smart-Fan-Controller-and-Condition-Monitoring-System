...
character_framebuffer::CharacterFramebuffer::DisplayState character_framebuffer::CharacterFramebuffer::init_operations(const struct device* const monochrome_display_device_ptr) {
	...
	character_framebuffer::CharacterFramebuffer::DisplayState display{{monochrome_display_device_ptr}, {display_width_px}, {display_height_px}};
